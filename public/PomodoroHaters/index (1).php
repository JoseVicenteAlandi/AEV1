...
function litrosColirio($mapa){
    ...
    foreach ($mapa as $valor){
        ...
        $TotalLitros= 25 * $habitantes;
    }
    echo "AFECTADOS <br>";
    echo "Hay $habitantes en afectados en total <br>";
    echo "<br>";
    echo "LITROS TOTALES <br>";
    echo "Se necesitan un total de $TotalLitros L";
}
...
function dañosTotales(&$mapa, $impactos){
    ...
    foreach ($mapa as $valor){
        ...
        $TotalDaños = $dañosUrbanos + $dañosNoUrbanos ;
    }
} 
echo "DAÑOS TOTALES <br>";
echo "Los costes totales de los daños son :$TotalDaños €";
}
...
$venta= 5 * $pescadoTotal;
$resultadoventa= round($venta, 0);
}
echo "VENTAS <br>";
echo "Podriamos ganar $resultadoventa € vendiendo pescado" ;
}
